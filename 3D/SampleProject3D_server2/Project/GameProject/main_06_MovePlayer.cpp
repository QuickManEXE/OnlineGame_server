...
void MainLoop(void) {
	...
	//カメラコントロール
	ControllCamera(pos + CVector3D(0, 50, 0));
	...
	//キー入力方向
	Utility::DrawLine(CVector2D(32, 32), CVector2D(32,132), CVector4D(0, 0, 0, 1));
	Utility::DrawLine(CVector2D(32, 132), CVector2D(132, 132), CVector4D(0, 0, 0, 1));
	Utility::DrawLine(CVector2D(132, 132), CVector2D(132, 32), CVector4D(0, 0, 0, 1));
	Utility::DrawLine(CVector2D(132, 32), CVector2D(32, 32), CVector4D(0, 0, 0, 1));
	Utility::DrawLine(CVector2D(50+32,50+32), CVector2D(50 + 32, 50 + 32) + CVector2D(-key_dir.x*50, -key_dir.z*50), CVector4D(0, 0, 0, 1));


	FONT_T()->Draw(142, 32, 0, 0, 0, "カメラの回転値 　%.2f", RtoD(cam_ang));
	FONT_T()->Draw(142, 64, 0, 0, 0, "方向キーの回転値 %.2f", RtoD(key_ang));
