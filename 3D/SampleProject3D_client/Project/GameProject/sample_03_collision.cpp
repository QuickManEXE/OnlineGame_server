...
//球1
//座標
CVector3D pos1(0,0,0);
//半径
float radius1 = 1.5f;
//球2
//座標
CVector3D pos2(0,0,10);
//半径
float radius2 = 1.0f;
void MainLoop(void) {
	...
	//球の表示
	//					座標、半径、色
	Utility::DrawSphere(pos1, radius1, CVector4D(1, 0, 0, 1));
	Utility::DrawSphere(pos2, radius2, CVector4D(0, 1, 0, 1));
